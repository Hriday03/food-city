...
<head>
    ...
    <title>Food-City: Customer Home</title>
...
<body>
    <div class="sidenav">
        ...
        <br><br><br><br>
        <img src="images/hamburger.png" alt="" style="height:160px; width:160px; margin-left:19px" />
        ...
        <header class="header_section">
            <div class="container">
                <nav class="navbar navbar-expand-lg custom_nav-container pt-3">
                    <a class="navbar-brand" href="welcome" style="margin-left:-90px">
